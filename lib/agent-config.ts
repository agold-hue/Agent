...
export const tools: ToolDef[] = [
  ...
  fn("browser_extract", "Pull the page's table, grid or repeated list (transactions, orders, statements, search results) out as rows of cells in JSON, in one call instead of scrolling and reading. `scroll` loads lazy lists to the end first.", obj({ scroll: { type: "boolean" }, max_rows: { type: "number" } })),
